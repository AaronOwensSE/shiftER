...
This project will utilized a classic *layered architectural model* with frontend, backend, and database layers. The backend and database layers will be accounted for by the broader backend API, which will be written in JavaScript to utilize the Node.js runtime and a PostgreSQL DBMS. Although the initial frontend will be written in React Native for mobile devices, the project will support the possibility of additional frontend options, such as a website frontend.
